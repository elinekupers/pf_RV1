...
saveFigures = true;  
loadDataFromServer = true; % TODO: load from OSF web page instead of winawerlab server
...
if loadDataFromServer
    % Load from server. 
    load(fullfile(pfRV1rootPath, 'external', 'data', 'benson2020','V1AreaHCP_sum.mat'),'mdHVA', 'stdHVA', 'mdVMA', 'stdVMA', 'allUpr', 'allLowr', 'allHorz', 'allVert')
else
...
set(gca, 'XLim', [0 10], 'YLim', [0,2.5], 'XScale', 'linear', 'YScale', 'linear', 'TickDir', 'out', ...
         'XGrid','on', 'YGrid','on','XMinorGrid','off','YMinorGrid','off','GridAlpha',0.25, ...
         'LineWidth',1,'FontSize',15); box off;
set(gca, 'XTick', [0:2:10], 'XTickLabel', sprintfc('%d',[0:2:10]))
