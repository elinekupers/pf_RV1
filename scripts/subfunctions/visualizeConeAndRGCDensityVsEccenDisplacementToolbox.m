...
title('ISETBIO (black) vs DisplacementMap (light gray): Cone HVA VMA Curcio et al 1990')
...
title('ISETBIO (black) vs DisplacementMap (light gray) vs Song (dark gray): Cone HVA VMA Curcio et al 1990')
