...
# you want to run.
matlab -nodisplay -r "addpath(genpath('/scratch/ek99/pf_RV1')); addpath(genpath('/scratch/ek99/JWLOrientedGabor')); addpath(genpath('/scratch/ek99/isetbio')); [expName, subFolder, seed] = prepHPC($SLURM_ARRAY_TASK_ID); linearRGCModel(pfRV1rootPath, subFolder, expName, seed); exit()"
