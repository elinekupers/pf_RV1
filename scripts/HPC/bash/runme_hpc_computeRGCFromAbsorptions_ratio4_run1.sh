...
# you want to run.
matlab -nodisplay -r "addpath(genpath('/scratch/ek99/pf_RV1')); addpath(genpath('/scratch/ek99/JWLOrientedGabor')); addpath(genpath('/scratch/ek99/isetbio')); [expName, subFolder, seed] = pfRV1_prepHPC(1); linearRGCModel(pfRV1rootPath, subFolder, expName, seed, 4,$SLURM_ARRAY_TASK_ID); exit()"
