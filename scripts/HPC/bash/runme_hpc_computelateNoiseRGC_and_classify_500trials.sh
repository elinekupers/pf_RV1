...
#SBATCH --job-name=lateNoiseRGCModel_LOnly_500trials
...
# you want to run.
matlab -nodisplay -r "addpath(genpath('/scratch/ek99/JWLOrientedGabor')); addpath(genpath('/scratch/ek99/pf_RV1')); addpath(genpath('/scratch/ek99/isetbio')); RGCmodel_filterAndClassify(2, $SLURM_ARRAY_TASK_ID); exit()"
