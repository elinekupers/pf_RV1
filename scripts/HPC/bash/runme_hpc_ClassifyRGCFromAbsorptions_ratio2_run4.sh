...
# you want to run.
matlab -nodisplay -r "addpath(genpath('/scratch/ek99/pf_RV1')); addpath(genpath('/scratch/ek99/JWLOrientedGabor')); addpath(genpath('/scratch/ek99/isetbio')); [expName, subFolder, seed] = pfRV1_prepHPC(4); linearRGCModel_Classify(pfRV1rootPath, subFolder, expName, seed, 2, $SLURM_ARRAY_TASK_ID); exit()"
